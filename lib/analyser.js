...
function classifyFile(rel) {
  ...
  // "component" bucket, so App-Router projects come out mis-classified.
  if (isCode && inDir('app')) {
...
module.exports = {
  analyse, classifyFile, parseImports, resolveImport, loadAliases, detectCustomHook, parseRoutes,
